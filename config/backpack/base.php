...
return [
    ...
    */
    ...
    'styles' => [
        ...
        'packages/backpack/base/css/kappa.css',
    ...
    'project_logo'   => '<div style="color:#6956de"><b>IoT</b></div> <b>Metrics </b>',
    ...
    'home_link' => env('APP_ENV') === 'local' ? '/admin/dashboard' : 'https://backpackforlaravel.com',

    // Show / hide breadcrumbs on admin panel pages.
    'breadcrumbs' => true,

    // Horizontal navbar classes. Helps make the admin panel look similar to your project's design.
    'header_class' => 'app-header navbar  border-0',
