@if ($crud->hasAccess('bulkClone') && $crud->get('list.bulkActions'))
  <a href="javascript:void(0)" onclick="bulkCloneEntries(this)" class="btn btn-sm btn-secondary bulk-button"><i class="fa fa-clone"></i> View Metrics</a>
@endif
...
<script>
  if (typeof bulkCloneEntries != 'function') {
    function bulkCloneEntries(button) {
        ...
        message = message.replace(":number", crud.checkedItems);
